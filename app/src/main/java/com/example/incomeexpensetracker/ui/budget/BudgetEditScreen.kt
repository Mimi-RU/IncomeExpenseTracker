...
@Composable
fun budgetEditScreen(navHostController: NavHostController, id: Int) {

    val budgetViewModel: BudgetViewModel = hiltViewModel()
    val categoryViewModel: CategoryViewModel = hiltViewModel()

    LaunchedEffect(key1 = id) {
        budgetViewModel.getSelectedBudgetWithRelation(id)
    }
    val budgetToEdit = budgetViewModel.selectedBudgetWithRelation.value

    if (budgetToEdit !== null) {
        budgetViewModel.updateBudgetFields(budgetToEdit)
    }
...
@Composable
fun budgetEditTopBar(navHostController: NavHostController, budgetViewModel: BudgetViewModel) {
    ...
    TopAppBar(
        ...
        actions = {
            ...
            IconButton(onClick = {
                ...
                Icon(imageVector = Icons.Default.Delete, contentDescription = "Delete Budget")
